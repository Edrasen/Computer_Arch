...
HD_PWD='D:/ESCOM/2020A/ARQUITECTURA/Practica2/PRACTICA02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Suma8Bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Suma8Bits.tcl -notrace
