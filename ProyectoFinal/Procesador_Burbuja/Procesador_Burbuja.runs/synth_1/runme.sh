...
HD_PWD='D:/ESCOM/ARQUITECTURA/ProyectoFinal/Procesador_Burbuja/Procesador_Burbuja.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sim2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sim2.tcl
