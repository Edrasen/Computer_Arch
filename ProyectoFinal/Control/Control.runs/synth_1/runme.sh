...
HD_PWD='D:/ESCOM/ARQUITECTURA/ProyectoFinal/Control/Control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Componentes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Componentes.tcl
