...
HD_PWD='D:/ESCOM/ARQUITECTURA/Mux2can/Mux2can.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux2chan.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux2chan.tcl
