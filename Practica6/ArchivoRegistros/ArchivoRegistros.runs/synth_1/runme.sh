...
HD_PWD='D:/ESCOM/ARQUITECTURA/ArchivoRegistros/ArchivoRegistros.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ArchivoRegistro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ArchivoRegistro.tcl
