...
HD_PWD='D:/ESCOM/ARQUITECTURA/BarrelShifter/BarrelShifter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log barrelSh.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source barrelSh.tcl
