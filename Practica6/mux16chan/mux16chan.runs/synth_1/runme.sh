...
HD_PWD='D:/ESCOM/ARQUITECTURA/mux16chan/mux16chan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux16chan.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux16chan.tcl
