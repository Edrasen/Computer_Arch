...
HD_PWD='D:/ESCOM/ARQUITECTURA/Practica8/MemoriaPrograma.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MemoPrograma.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MemoPrograma.tcl
