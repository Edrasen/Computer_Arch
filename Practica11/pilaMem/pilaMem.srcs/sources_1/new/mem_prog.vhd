...
entity mem_prog is
   ...
   Port ( pc : in  STD_LOGIC_VECTOR ((num_p - 1) downto 0);
          inst : out  STD_LOGIC_VECTOR ((tam_p - 1) downto 0)
	);
end mem_prog;
...
op_li&r6&x"0087", 				--1. li r6 #87
op_li&r8&x"0090",			    --2. li r8 #90
op_add&r8&r2&r3&su&id_add,
op_sub&r1&r2&r3&su&id_sub,
op_call&su&x"0009",
op_li&r6&x"0087", 				--li r6 #87  
op_li&r8&x"0090",			    --li r8 #90
op_call&su&x"000D",				--call 13
op_swi&r1&x"0030",				--swi r1,5
op_add&r8&r2&r3&su&id_add,
op_sub&r1&r2&r3&su&id_sub,
op_li&r6&x"0087",			    --li r6 #87
