...
HD_PWD='C:/Users/alain/Desktop/PRACTICA02/PRACTICA02.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Suma8Bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Suma8Bits.tcl
