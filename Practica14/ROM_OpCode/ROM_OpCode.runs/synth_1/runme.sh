...
HD_PWD='D:/ESCOM/ARQUITECTURA/Practica14/ROM_OpCode/ROM_OpCode.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CodOperROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CodOperROM.tcl
