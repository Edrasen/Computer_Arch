...
HD_PWD='D:/ESCOM/ARQUITECTURA/Practica14/InstructDecoder/InstructDecoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DecoIns.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DecoIns.tcl
