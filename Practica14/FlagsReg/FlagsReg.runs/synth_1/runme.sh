...
HD_PWD='D:/ESCOM/ARQUITECTURA/Practica14/FlagsReg/FlagsReg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RegFlags.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RegFlags.tcl
