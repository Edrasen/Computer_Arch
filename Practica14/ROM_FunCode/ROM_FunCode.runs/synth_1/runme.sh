...
HD_PWD='D:/ESCOM/ARQUITECTURA/Practica14/ROM_FunCode/ROM_FunCode.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CodFunROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CodFunROM.tcl
