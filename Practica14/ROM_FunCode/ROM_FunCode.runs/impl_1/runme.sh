...
HD_PWD='D:/ESCOM/ARQUITECTURA/Practica14/ROM_FunCode/ROM_FunCode.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CodFunROM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CodFunROM.tcl -notrace
