...
HD_PWD='D:/ESCOM/ARQUITECTURA/Practica14/LevelDetect/LevelDetect.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DetectorNivel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DetectorNivel.tcl
