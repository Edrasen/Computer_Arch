...
HD_PWD='D:/ESCOM/ARQUITECTURA/Practica14/Condition/Condition.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VerifCond.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VerifCond.tcl
