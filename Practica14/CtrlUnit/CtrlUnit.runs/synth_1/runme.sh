...
HD_PWD='D:/ESCOM/ARQUITECTURA/Practica14/CtrlUnit/CtrlUnit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UC.tcl
